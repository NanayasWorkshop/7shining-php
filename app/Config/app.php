...
define('SITE_DESCRIPTION', 'Mehr als ein Verein - eine Bewegung für Wachstum und Werte');
...
// Environment f�r Production �ndern
define('ENVIRONMENT', 'production'); // statt 'development'
define('DEBUG_MODE', false); // f�r Production
